...
<section id="modificar" name="Modificar Libro">
  ...
  <form method="POST" action="{{ route('postModificar') }}" id="modificar-libro">
    ...
    <div id="inicio" class="form-group row">
      ...
      <div class="col-sm-10">
        <input class="form-control col-sm-5" autocomplete="off" type="date" name="fechaInicio" id="input-inicio" value="{{ $libro->idacticidad }}">
      </div>
    </div>
    <div id="termino" class="form-group row">
      <label for="input-termino" class="col-sm-2 col-form-label">Fecha de término</label>
      <div class="col-sm-10">
        <input class="form-control col-sm-5" type="date" autocomplete="off" name="fechaTermino" id="input-termino" value="{{ $libro->idactividad}}">
      </div>
    </div><br>
