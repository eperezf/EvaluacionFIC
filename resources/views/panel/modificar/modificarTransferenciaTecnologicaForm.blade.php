...
<section id="modificar" name="Modificar Tranferencia Tecnológica">
  ...
  <form method="POST" action="{{ route('postModificar') }}" id="modificar-transferenciatecnologica">
    ...
    <div id="inicio" class="form-group row">
      ...
      <div class="col-sm-9">
        <input class="form-control col-sm-5" type="date" autcomplete="off" name="fechaInicio" id="input-inicio" value="{{ $transferenciatecnologica->idactividad }}">
      </div>
    </div>
    <div id="termino" class="form-group row">
      <label for="input-termino" class="col-sm-3 col-form-label">Fecha de término</label>
      <div class="col-sm-9">
        <input class="form-control col-sm-5" type="date" autocomplete="off" name="fechaTermino" id="input-termino" value="{{ $transferenciatecnologica->idactividad }}">
      </div>
    </div><br>
