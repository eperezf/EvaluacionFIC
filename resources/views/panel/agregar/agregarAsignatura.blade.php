...
<section id="agregar" name="Agregar Asignatura">
  ...
  <form method="POST" action="{{ route('postAsignatura') }}" id="agregar-asignatura">
    ...
    <div id="asignatura" class="form-group row">
      ...
      <div class="col-sm-10">
        <input name="nombre" class="form-control col-sm-5" placeholder="Nombre Asignatura" type="text" id="input-asignatura" value="{{ old('asignatura') }}">
      </div>
    </div>
    <div id="subarea" class="form-group row">
      <label for="select-subarea" class="col-sm-2 col-form-label">Área</label>
      <div class="col-sm-10">
