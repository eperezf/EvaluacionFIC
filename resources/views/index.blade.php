...
<head>
    ...
    <title>GestiónFIC - Index</title>
</head>
<body>
    <h1>Bienvenido/a {{ $nombre }}, te deseamos un magnífico día.</h1>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Para cerrar sesión haga click en cerrar sesión o haga click en cancelar para mantener sus sesión iniciada.</p>
                    </div>
