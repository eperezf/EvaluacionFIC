...
class UpdateCursoDocencia extends FormRequest
{
    ...
    {
        return [
            'calificacion' => ['numeric', 'min:1', 'max:7'],
            'nota' => ['numeric', 'min:1', 'max:7'],
            'bonificacion' => ['numeric', 'min:1', 'max:7'],
        ];
    }
    ...
    public function messages() {
        return [
            ...
            'nota.numeric' => "La nota del superior debe ser un número.",
            'nota.min' => "La nota del superior no puede ser menor a 1",
            'nota.max' => "La nota del superior no puede ser mayor a 7",
